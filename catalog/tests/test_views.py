...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_pages_ordered_by_due_date(self):
        ...
        login = self.client.login(username='testuser1', passwords='1X<ISRUkw+tuK')
        response = self.client.get(reverse('my-borrowed'))
...
class RenewBookInstancesViewTest(TestCase):
    def setUp(self):
        ...
        # Create a book
        test_author = Author.objects.create(first_name='John', last_name='Smith')
        Genre = Genre.objects.create('Fantasy')
        test_language = Language.objects.create(name='English')
        test_book = Book.objects.create(
            title='Book Title',
            summary='My book summary',
        ...
        def test_form_renewal_date_initially_has_date_three_weeks_in_future(self):
            ...
            date_3_weeks_in_future =datetiem.date.today() + datetime.timedelta(weeks=3)
        ...
        def test_redirects_to_all_borrowed_book_list_on_success(self):
            ...
            self.assertRedirects(response, reverse('the-borrowed'))
            
        def test_form_invalid_renewal_date_past(self):
            login = self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
            date_in_past = datetime.datetoday() - datetime.timedelta(weeks=1)
...
class AuthorCreateTestView(TestCase):
    def setUp(self):
        ...
        self.sample_author = Author.objects.create(
            first_name = 'John',
            last_name = 'Smith',
            date_of_birth = '05/02/2020',
            date_of_death = '05/10/2100'
    ...
    def test_variables(self):
        response = self.client.get(reverse('author-create', kwargs={'pk': self.sample_author.pk}))
        self.assertEqual(response.status_code, 200)
